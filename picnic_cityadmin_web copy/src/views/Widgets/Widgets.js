    ...
    return (
      <div className="animated fadeIn">
        <Row>
          ...
          <Col xs="12" sm="6" lg="3">
            <Widget01  color="success" variant="inverse" header="89.9%" />
          </Col>
          <Col xs="12" sm="6" lg="3">
        ...
        <Row>
          <Col xs="12" sm="6" lg="3">
            <Widget02 header="$1.999,50" mainText="Income" icon="fa fa-cogs"  color="success" />
          </Col>
          <Col xs="12" sm="6" lg="3">
          ...
          <Col xs="12" sm="6" lg="3">
            <Widget02 header="$1.999,50" mainText="Income" icon="fa fa-cogs"  color="success" footer link="#/charts" />
          </Col>
          <Col xs="12" sm="6" lg="3">
        ...
        <Row>
          <Col xs="12" sm="6" lg="3">
            <Widget02 header="$1.999,50" mainText="Income" icon="fa fa-cogs"  color="success" variant="1" />
          </Col>
          <Col xs="12" sm="6" lg="3">
          ...
          <Col xs="12" sm="6" lg="3">
            <Widget02 header="$1.999,50" mainText="Income" icon="fa fa-cogs"  color="success" variant="2" />
          </Col>
          <Col xs="12" sm="6" lg="3">
        ...
        <CardGroup className="mb-4">
          ...
          <Widget04 icon="icon-pie-chart"  color="success" header="28%" value="25">Returning Visitors</Widget04>
        ...
        <Row>
          ...
          <Col sm="6" md="2">
            <Widget04 icon="icon-pie-chart"  color="success" header="28%" value="25" invert>Returning Visitors</Widget04>
          </Col>
          <Col sm="6" md="2">
