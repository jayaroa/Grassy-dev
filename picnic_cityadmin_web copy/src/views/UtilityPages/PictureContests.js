...
class Contests extends Component {
  ...
  editContest(contestId) {
    this.props.history.push(`/picturecontests/picturecontestdetails/${contestId}`);
  }
          ...
          <Col>
            <Card>
              <CardHeader>
                ...
                <Link to="/picturecontests/picturecontestdetails/new">
...
<Row>
<Col md="8">Award amount: ${eachDetails.awardAmount}</Col>
</Row>
<Row>
